...
\begin{frame}
  ...
  \begin{multicols}{2}
    \only<1>{\includegraphics[width=0.52\textwidth,height=0.3\textwidth]{../tabs/mla_complete.jpg}}
    \only<2>{\includegraphics[width=0.52\textwidth,height=0.3\textwidth]{../pics/gazebo.jpg}}
    \only<3>{\includegraphics[width=0.52\textwidth,height=0.3\textwidth]{../pics/soccer_simulation_3d.png}}
    \only<4-5>{\includegraphics[width=0.52\textwidth,height=0.3\textwidth]{../pics/klingen_sim.png}}
...
\begin{frame}
  ...
  \begin{columns}
    \column[c]{0.5\textwidth}
    \center
    \only<1-5>{\includegraphics[width=\textwidth]{../pics/eval_two}}\\
    %\hspace{0.5cm}\\
